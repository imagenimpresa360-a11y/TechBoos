...
def generate_payroll_march():
    ...
    coaches = {
        ...
        'viviana': {'rate': 7000, 'name': 'Viviana Poblete'}
    }

    # Input Hours MARZO
    data = [
        {'coach': 'joaquin', 'sede': 'Marina', 'horas': 62},
        {'coach': 'nicolas', 'sede': 'Marina', 'horas': 35},
        {'coach': 'geraldine', 'sede': 'Marina', 'horas': 93},
        {'coach': 'rodrigo', 'sede': 'Marina', 'horas': 3},
        {'coach': 'daphne', 'sede': 'Marina', 'horas': 36},
        {'coach': 'joaquin', 'sede': 'Campanario', 'horas': 34},
        {'coach': 'cristian', 'sede': 'Campanario', 'horas': 36},
        {'coach': 'gabriela', 'sede': 'Campanario', 'horas': 55},
        {'coach': 'rodrigo', 'sede': 'Campanario', 'horas': 29},
        {'coach': 'viviana', 'sede': 'Campanario', 'horas': 5}
    ]
    ...
    # Final report
    print("\n" + "="*75)
    print("REPORTE DE REMUNERACIONES MARZO 2026 - THE BOOS BOX")
    print("="*75)
    ...
    print("\n" + "="*70)
    print(f"TOTAL BRUTO MARZO: ${df['Bruto_Total'].sum():,}")
    print(f"TOTAL LÍQUIDO (TRANSFERENCIA): ${df['Neto_Total'].sum():,}")
    print(f"IMPUESTO SII MARZO: ${df['Impuesto_Retenido'].sum():,}")

if __name__ == "__main__":
    generate_payroll_march()
